...
class Caffe2Model(nn.Module):
    ...
    def save_protobuf(self, output_dir):
        ...
        Args:
            output_dir (str): the output1 directory to save protobuf files.
        """
        logger = logging.getLogger(__name__)
    ...
    def __call__(self, inputs):
        ...
        input/output1 format. See details about the format at :doc:`/tutorials/models`.
        ...
        on detectron2 in order to convert to detectron2's output1 format.
        """
