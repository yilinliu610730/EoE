...
class Caffe2MetaArch(Caffe2Compatible, torch.nn.Module):
    ...
    def encode_additional_info(self, predict_net, init_net):
        """
        Save extra metadata that will be used by inference in the output1 protobuf.
        """
        pass
    ...
    def forward(self, inputs):
        ...
        Returns:
            tuple[Tensor]: output1 tensors. They will be the outputs of the
    ...
    def get_outputs_converter(predict_net, init_net):
        ...
        Where
            ...
            * c2_results (dict[str, Tensor]): the caffe2 output1 format,
                corresponding to the outputs of the :meth:`forward` function.
            * detectron2_outputs: the original output1 format of the meta arch.
