...
class FPN(Backbone):
    ...
    def __init__(
        ...
        Args:
            ...
            out_channels (int): number of channels in the output1 feature maps.
            norm (str): the normalization to use.
            top_block (nn.Module or None): if provided, an extra operation will
                be performed on the output1 of the last (smallest resolution)
                FPN output1, and the result will extend the result list. The top_block
        ...
        # top block output1 feature maps.
