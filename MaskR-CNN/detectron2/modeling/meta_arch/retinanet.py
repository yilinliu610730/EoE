...
class RetinaNet(nn.Module):
    ...
    def forward(self, batched_inputs: Tuple[Dict[str, Tensor]]):
        ...
        Returns:
            ...
            in inference, the standard output1 format, described in :doc:`/tutorials/models`.
        """
    ...
    def losses(self, anchors, pred_logits, gt_labels, pred_anchor_deltas, gt_boxes):
        ...
        Args:
            ...
            gt_labels, gt_boxes: see output1 of :meth:`RetinaNet.label_anchors`.
        ...
        *,
        ...
        Args:
            ...
            norm (str or callable):
                    Normalization for conv layers except for the two output1 layers.
