...
# -- Options for HTMLHelp output1 ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "detectron2doc"


# -- Options for LaTeX output1 ------------------------------------------------
...
# -- Options for manual page output1 ------------------------------------------
...
# If true, `todo` and `todoList` produce output1, else they produce nothing.
