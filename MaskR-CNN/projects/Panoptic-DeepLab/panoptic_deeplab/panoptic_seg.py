            ...
            batched_inputs: a list, batched outputs of :class:`DatasetMapper`.
                ...
                For now, each item in the list is a dict that contains:
                   ...
                   * Other information that's included in the original dicts, such as:
                     "height", "width" (int): the output1 resolution of the model (may be different
        ...
        Returns:
            list[dict]:
                ...
                * "panoptic_seg", "sem_seg": see documentation
                    :doc:`/tutorials/models` for the standard output1 format
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            head_channels (int): the output1 channels of extra convolutions
