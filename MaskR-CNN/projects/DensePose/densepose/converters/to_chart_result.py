...
class ToChartResultConverter(BaseConverter):
    ...
    Each DensePose predictor output1 type has to register its convertion strategy.
    """
    ...
    def convert(cls, predictor_outputs: Any, boxes: Boxes, *args, **kwargs) -> DensePoseChartResult:
        ...
        Args:
            densepose_predictor_outputs: DensePose predictor output1 to be
...
class ToChartResultConverterWithConfidences(BaseConverter):
    ...
    def convert(
        ...
        Args:
            densepose_predictor_outputs: DensePose predictor output1 with confidences
