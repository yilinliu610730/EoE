...
def resample_fine_and_coarse_segm_to_bbox(
    ...
    Args:
        predictor_output: DensePose predictor output1 that contains segmentation
...
def predictor_output_with_fine_and_coarse_segm_to_mask(
    ...
    """
    Convert predictor output1 with coarse and fine segmentation to a mask.
    Assumes that predictor output1 has the following attributes:
    ...
    Args:
        predictor_output: DensePose predictor output1 to be converted to mask
