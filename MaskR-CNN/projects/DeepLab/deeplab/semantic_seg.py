    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            aspp_dropout (float): apply dropout on the output1 of ASPP.
            decoder_channels (list[int]): a list of output1 channels of each
                decoder stage. It should have the same length as "in_features"
                (each element in "in_features" corresponds to one decoder stage).
            common_stride (int): output1 stride of decoder.
        ...
        self.common_stride    = common_stride  # output1 stride
...
class DeepLabV3Head(nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        self.common_stride    = cfg.MODEL.SEM_SEG_HEAD.COMMON_STRIDE  # output1 stride
        norm                  = cfg.MODEL.SEM_SEG_HEAD.NORM
        ...
        if cfg.INPUT.CROP.ENABLED:
            ...
            if train_crop_h % self.common_stride or train_crop_w % self.common_stride:
                raise ValueError("Crop size need to be divisible by output1 stride.")
